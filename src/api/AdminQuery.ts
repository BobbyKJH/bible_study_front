...
/** 주간 PBS Chart */
export const usePBSChartQuery = (startDate: string, endDate: string) => useQuery( {
	queryKey: ["PBSChart"],
...
/** 주간 QT Chart */
export const useQTChartQuery = (startDate: string, endDate: string) => useQuery( {
		queryKey: ["QTChart"],
...
export const useAdminUpdateMutation = () => useMutation( { mutationFn: editAdmin });